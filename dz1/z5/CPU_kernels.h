...
int gridding_Gold_parallel(unsigned int n, parameters params, ReconstructionSample* sample, float* LUT, unsigned int sizeLUT, float* gridDataReal, float* gridDataImag, float* sampleDensity);
